const TRANSLATIONS = {
  ...
  'sobre.p2': {
    pt: 'Em pouco mais de 3 anos com <strong>Flutter e Dart</strong>, construí seis projetos — cinco apps Android no Google Play, um site web de jogos diversos e três apps em desenvolvimento ativo. Cada um nasceu de uma necessidade concreta: uma calculadora estilo neumórfico, um buscador de CEP ágil, um organizador de compras intuitivo, um campo minado reinventado. Problemas simples, resolvidos com capricho e atenção ao detalhe.',
    en: "In just over 3 years with <strong>Flutter and Dart</strong>, I've built six projects — five Android apps on Google Play, a website with assorted games, and three apps in active development. Each one came from a real need: a neumorphic-style calculator, a fast CEP lookup tool, an intuitive shopping list organizer, a reinvented minesweeper. Simple problems, solved with care and attention to detail.",
    es: 'En poco más de 3 años con <strong>Flutter y Dart</strong>, construí seis proyectos — cinco apps Android en Google Play, un sitio web de juegos variados y tres apps en desarrollo activo. Cada uno nació de una necesidad concreta: una calculadora estilo neumórfico, un buscador de CEP ágil, un organizador de compras intuitivo, un buscaminas reinventado. Problemas simples, resueltos con esmero y atención al detalle.',
  },
  'sobre.p3': {
  ...
  'apps.link-site': { pt: 'Visitar site do jogo →', en: 'Visit the game website →', es: 'Visitar el sitio del juego →' },
